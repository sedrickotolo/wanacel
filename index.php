    ...
    <header class="site-navbar js-sticky-header site-navbar-target" role="banner">
        <div class="topbar af-white-bg">
          <div class="container d-flex align-items-center py-1">
              <div class="col">
                  <ul class="nav">
                      <li class="nav-item"><a class="nav-link" href="https://www.facebook.com/wanacelfoundation"><i class="fab fa-facebook indigo-text"></i></a></li>
                      <li class="nav-item"><a class="nav-link" href="https://www.twitter.com/wanacelf"><i class="fab fa-twitter indigo-text"></i></a></li>
                  </ul>
              </div>
      ...
      <div class="container py-3">
        <div class="row align-items-center position-relative">
          <div class="site-logo">
              <a href="index.php" class="text-black"><img src="images/logo.jpeg" class="logoclass mr-2" alt=""><span class="text-primary logocolor">Wanacel</a>
          </div>
    ...
    <div class="site-section bg-light counter" id="what-we-do-section">
      <div class="container">
        <div class="row mb-5 justify-content-center">
          <div class="col-md-112 text-center">
            <div class="block-heading-">
              <h2 class="section-title text-uppercase wanacel_color">What we do<span class="dot"></span></h2>
  ...
  <div class="site-section indigo-bg counter" id="Our-impact-section">
      ...
      <div class="container">
        <div class="row mb-5 justify-content-center">
          <div class="col-md-9 text-center">
              <h2 class="text-black text-uppercase section-title wanacel_color">Our Leadership<span class="dot"></span></h2>
              <div class="section-content">
    ...
    <div class="site-section" id="gallery-section">
      <div class="container-fluid">
        <div class="row mb-5 justify-content-center">
          <div class="block-heading">
            <h2 class="section-title text-uppercase wanacel_color">Gallery<span class="dot"></span></h2>
          </div>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-7 text-center mb-5 text-center">
            <h2 class="text-black text-uppercase section-title wanacel_color">Our Blog<span class="dot"></span></h2>
            <p>.</p>
          </div>
        </div>
        <div class="row">
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12 text-center mb-5">
            <h2 class="text-black section-title text-uppercase wanacel_color">Contact Us<span class="dot"></span></h2>
          </div>
        </div>
        <div class="row justify-content-center">
          <div class="col-lg-6 mb-5">
